function taoDiv(soHang, soCot, mauNen, mauVien) {
  var khung = document.getElementById("khung");
  var tongThe = soHang * soCot;
  ...
  for (var j = 0; j < danhSach.length; j++) {
    ...
    the.className = "the";
    the.style.backgroundColor = mauNen;
    the.style.border = "2px solid " + mauVien;
    ...
    truoc.style.backgroundColor = mauNen;
    truoc.style.border = "2px solid " + mauVien;
